...
export default function Navbar() {
  ...
  return (
    <nav className="flex justify-between items-center px-2 py-4 md:py-2 md:px-4 lg:px-8 relative z-10">
      ...
      <div className={`links flex ${isNavOpen ? "flex" : "hidden"} md:flex md:gap-12 absolute md:static right-0 top-0 h-full w-3/5 md:w-auto bg-primary-color md:bg-transparent transition-width duration-300 ease-in-out md:opacity-100 md:visibility-visible`}>
        <ul className="flex flex-col md:flex-row items-center justify-center md:gap-6 text-white md:text-black w-full h-full">
          ...
          <li className='text-black-800 hover:text-orange-400 border-b-[2px solid black]'><a href="#destination" className="hover:text-primary-color">Destination</a></li>
          <li className='text-black-800 hover:text-orange-400 border-b-[2px solid black]'><a href="#offer" className="hover:text-primary-color">Offer</a></li>
          <li className='text-black-800 hover:text-orange-400 border-b-[2px solid black]'><a href="#tour" className="hover:text-primary-color">Tour</a></li>
